...
const JoinPage = ({ params }: { params: { workspaceId: Id<"workspaces"> } }) => {
  ...
  const { mutate, isLoading: joining } = useJoin();
  ...
  return (
    <div className="h-full flex flex-col gap-y-8 items-center justify-center bg-white p-8 rounded-lg shadow-md">
      <Image src="/collab-logo.png" width={100} height={100} alt="logo" />
      <div className="flex flex-col gap-y-4 items-center justify-center max-w-md">
        ...
        <VerificationInput
          length={6}
          classNames={{
            container: cn("flex gap-x-2", joining && "opacity-50 cursor-not.allowed"),
            character:
