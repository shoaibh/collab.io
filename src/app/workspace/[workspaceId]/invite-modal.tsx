...
export const InviteModal = ({ open, setOpen, name, joinCode }: InviteModalProps) => {
  ...
  const [ConfirmDialog, confirm] = useConfirm("Are you sure you?", "This will deactivate the current invite code and generate a new one");
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Use the code to invite people</DialogDescription>
          </DialogHeader>
          ...
          <div className="flex items-center justify-between w-full">
            <Button disabled={isLoading} onClick={handleNewCode} variant="outline">
              New Code
